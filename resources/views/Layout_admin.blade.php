...
<head>
    ...
    <!-- Favicon -->
    <link rel="shortcut icon" type="image/x-icon" href="{{asset('frontend/images/Icon.png')}}">
    <title>Admin Shop Balo | @yield('title')</title>
    ...
    <nav class="navbar-default navbar-static-side" role="navigation">
            ...
            <ul class="nav metismenu" id="side-menu">
                <li class="nav-header">
                    <div class="dropdown profile-element">
                        <img alt="image" class="rounded-circle" src="{{ asset('backend/Doraemon.png') }}" height="48px" width="48px" />
                ...
                <li class="{{ route('category.index')==$url_canonical ? 'active' : '' }}">
                    ...
                    <ul class="nav nav-second-level collapse">
                        <li class="{{ route('category.index')==$url_canonical ? 'active' : '' }}"><a href="{{ route('category.index') }}">Danh Mục Sản Phẩm</a></li>
        ...
        <div class="navbar-header">
            ...
            <ul class="nav navbar-top-links navbar-right">
                <li>
                <span class="m-r-sm text-muted welcome-message">Chào mừng bạn đến với trang quản trị viên.</span>
                </li>
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-messages">
                        <li>
                            <div class="dropdown-messages-box">
                                ...
                                <div>
                                <small class="float-right">2 giờ trước</small>
                                    <strong>Mike Loreipsum</strong> Bắt đầu theo dõi <strong>Bạn</strong>. <br>
                                    <small class="text-muted">3 ngày trước lúc 7:58 chiều - 10.01.2025</small>
                                </div>
                            </div>
                        </li>
                        <li class="dropdown-divider"></li>
                        <li>
                            <div class="dropdown-messages-box">
                                ...
                                <small class="float-right text-navy">5 giờ trước</small>
                                    <strong>Chris Johnatan Overtunk</strong> bắt đầu theo dõi <strong>Bạn</strong>. <br>
                                    <small class="text-muted">Hôm qua 1:21 chiều - 06.01.2025</small>
                                </div>
                            </div>
                        </li>
                        <li class="dropdown-divider"></li>
                        <li>
                            <div class="dropdown-messages-box">
                                ...
                                <div>
                                    ...
                                    <strong>Monica Smith</strong> Yêu Thích Sản Phẩm Của <strong>Bạn</strong>. <br>
                                    <small class="text-muted">2 ngày trước lúc 2:30 sáng - 11.02.2025</small>
                                </div>
                            </div>
                        </li>
                        <li class="dropdown-divider"></li>
