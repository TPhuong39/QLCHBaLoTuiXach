    ...
    <div class="modal inmodal" id="Modal_delete" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content animated flipInY">
                ...
                <div class="modal-body">
                    <p>"Bạn có chắc chẵn xóa"<span id="body"></span>"?</p>
                </div>
    ...
    <script type="text/javascript">
        $(document).ready(function(){
                    ...
                    },
                    {
                        ...
                        render: function(data, type, full, meta){
                            if (data.coupon_condition == 1) {
                                return "<span class='expiry tag-style'>Tiền</span>";
                            }else{
                                return "<span class='still-term tag-style'>Phần Trăm</span>";
                            }
                        }
                    },
                    {
           ...
           $('#add_coupon').click(function(){
                ...
                $('.modal-title').text("Thêm Khuyến Mãi Mới");
                $('#action').val("Add");
