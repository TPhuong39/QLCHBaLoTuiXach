            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content animated bounceInRight">
                    <div class="modal-header">
                        ...
                        <small class="font-bold">Thông tin chi tiết đơn hàng đã đặt được thể hiện rõ ở dưới đây.</small>
                    </div>
                                ...
                                <div class="ibox-content">
                                    <div class="form-group">
                                        <select class="form-control" id="value">
                                            ...
                                            <option class="check PAYMENT" value="3">Thanh Toán Hoàn Tất</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
                    ...
                    {data: 'name_order'},
                    {
                        ...
                        render: function(data, type, full, meta){
                            if (data.order_status == 1) {
                                ...
                                return "<span class='still-term tag-style'>Đang Vận Chuyển</span>";
                            }else{
                                return "<span class='expiry tag-style'>Thanh Toán Hoàn Tất</span>";
                            }
                        }
                    },
                    {
