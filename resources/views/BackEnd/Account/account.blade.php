            ...
            <div class="modal-dialog">
                <div class="modal-content animated flipInY">
                    <div class="modal-header">
                        ...
                        <small class="font-bold">Thực hiện xóa tài khoản người dùng.</small>
                    </div>
                    <input type="hidden" name="hidden_id_account" id="hidden_id_account">
                    <div class="modal-body">
                        <p>Bạn có chắc chắn xóa"<span id="body_account"></span>"?</p>
                    </div>
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content animated bounceInRight">
                    <div class="modal-header">
                        ...
                        <small class="font-bold">Thông tin chi tiết của tài khoản được thể hiện ở dưới đây.</small>
                    </div>
            ...
            var table = $('#account_table').DataTable({
                ...
                columns: [
                    ...
                    {data: 'status'},
                    {
                        data: null,
                        render: function(data, type, full, meta){
                            if (data.level == 1) { // Phân quyền người dùng
