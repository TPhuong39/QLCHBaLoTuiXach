...
<head>
    ...
    <title>Shop Balo - @yield('title')</title>
...
<body class="cms-index-index cms-home-page">
    <div id="page">
                    ...
                    <div class="col-lg-7 col-md-6 col-sm-6 col-xs-3 hidden-xs category-search-form">
                        <div class="search-box">
                            <form id="search_mini_form" action="{{ route('home.create') }}" method="get">
                                ...
                                <input id="search" type="text" name="search" placeholder="Tìm kiếm toàn bộ sản phẩm ở đây..."
                        ...
                        <div class="top-cart-contain" id="top-cart-contain">
                            ...
                            <div class="mini-cart">
                                <div data-toggle="dropdown" data-hover="dropdown" class="basket dropdown-toggle">
                                    <a href="{{ route('cart.index') }}"><span class="price hidden-xs">GIỎ
                                            HÀNG</span>
                            ...
                            <div class="col-lg-7 col-md-9 col-xs-12 col-sm-8 offer-block">
                                <div class="feature-box first">
                                 ...
                                 <div class="feature-box last">
                                     <div class="content">
                                         <h3>Đường dây nóng 0981542810</h3>
                                     </div>
                                 </div>
                             </div>
        ...
        <footer class="footer">
                        ...
                        <div class="col-md-3 col-sm-6">
                         ...
                         <div class="col-md-3 col-sm-6">
                             ...
                             <div class="contacts-info">
                                <address>
                                    <i class="add-icon">&nbsp;</i> Ninh Kiều, Cần Thơ<br>
                                    &nbsp;
                                </address>
                                 <div class="phone-footer"><i class="phone-icon">&nbsp;</i> 0981542810
                                 </div>
                                 <div class="email-footer"><i class="email-icon">&nbsp;</i> <a
                                         href="mailto:abc@magikcommerce.com">tienphuong0309@gmail.com</a> </div>
                             </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="footer-bottom">
                <div class="container">
                    <div class="row">
                    <div class="col-sm-5 col-xs-12 coppyright"> &copy; {{ now()->format('Y') }} Tiền Phương.
    ...
    @endforeach
        ...
        @if (Session::get('message'))
            toastr.success(Session::get('message'), 'Thông Báo');
        @endif
        @if (Session::get('message_err'))
            toastr.error(Session::get('message_err'), 'Thông Báo');
        @endif
        <script>
